package es.unican.is2.impuestoCirculacion.rellenaAyuntamiento;
...
import es.unican.is2.impuestoCirculacion.dominio.*;
...
public class RellenaAyuntamiento {
	...
	public static void main(String args[]) {
		...
		Furgoneta f1 = null;
		try {
			t1 = new Turismo("1111-AAA", LocalDate.now().minusYears(5), 20.0);
			f1 = new Furgoneta("1111-BBB", LocalDate.now().minusMonths(15), 50.0);
		...
		Motocicleta m2 = null;
		try {
			t2 = new Turismo("2222-AAA", LocalDate.now().minusYears(30), 70);
			m2 = new Motocicleta("2222-BBB", LocalDate.now().minusDays(100), 50);
		} catch (OperacionNoValida e) {
		}
		...
		Turismo t3b = null;
		try {
			t3 = new Turismo("3333-AAA", LocalDate.now().minusYears(4).minusMonths(3).minusDays(23), 100);
			t3b = new Turismo("3333-BBB", LocalDate.now().minusYears(9).minusMonths(10).minusDays(3), 5);
		} catch (OperacionNoValida e) {
		}
		...
		Contribuyente c4 = new Contribuyente("Eugenia", "López", "Suárez", "44444444D");
